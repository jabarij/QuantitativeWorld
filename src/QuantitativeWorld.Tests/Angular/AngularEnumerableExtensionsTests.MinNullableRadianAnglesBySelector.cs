...
namespace QuantitativeWorld.Tests.Angular
{
    ...
    {
        public class MinNullableRadianAnglesBySelector : AngularEnumerableExtensionsTests
        {
            public MinNullableRadianAnglesBySelector(TestFixture testFixture) : base(testFixture) { }
